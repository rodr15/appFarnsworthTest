...
class FifteenChips extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void medidas() {
      ...
      len = (MediaQuery.of(context).size.width *(4/5)) /
          (numberObjectives);
      if (len < 1) {
        len = 10;
      }
    ...
    void colors() {
      ...
      for (int i = numberObjectives + 1; i > 0; i--) {
        for (int j = 0; j <= 2; j++) {
          rgb.add((Po[opcion][j] + v[j] * (i / (numberObjectives + 1))).round());
        }
    ...
    return Container(
      ...
      child: Stack(
        children: <Widget>[
          ...
          ObjectiveChips(10, len,chipsData,objectiveData,chipsColors,noMove),
          ObjectiveChips(11, len,chipsData,objectiveData,chipsColors,noMove),
          ObjectiveChips(12, len,chipsData,objectiveData,chipsColors,noMove),
          ObjectiveChips(13, len,chipsData,objectiveData,chipsColors,noMove),
          ObjectiveChips(14, len,chipsData,objectiveData,chipsColors,noMove),
